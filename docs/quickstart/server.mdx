...
To learn how to create sync and async MCP Servers, manually, consult the [Java SDK Server](https://github.com/modelcontextprotocol/java-sdk) documentation.
...
For manual MCP Server implementation, refer to the [MCP Server Java SDK documentation](https://github.com/modelcontextprotocol/java-sdk).
