...
### Kilo Code
[Kilo Code](https://kilocode.ai/) is a powerful AI coding assistant that integrates with MCP servers to enhance its capabilities.

**Key features:**
- Combines all features of Cline, Roo, and additonal features
- MCP marketplace for easy discovery and installation of MCP servers
- Displays configured MCP servers along with their tools, resources, and any error logs
- Open source ([GitHub repository](https://github.com/Kilo-Org/kilocode))

**Learn more:**
- [Demo video showing MCP usage in Kilo Code](https://www.youtube.com/watch?v=6O9RQoQRX8A)
