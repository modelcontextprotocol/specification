...
| [AgentR Wingmen][AgentR Wingmen]                 | ❌          | ❌        | ✅      | ❌                     | ❌         | ❌    | ❓            | Supports tools                                                                                  |
...
| [ChatGPT][ChatGPT]                               | ❌          | ❌        | ✅      | ❌                     | ❌         | ❌    | ❓            | Supports tools.                                                                                 |
...
| [Goose][Goose]                                   | ✅          | ✅        | ✅      | ❓                     | ❌         | ❌    | ❓            | Supports resources, prompts, and tools.                                                                                 |
...
[AgentR Wingmen]: https://wingmen.app/
...
[AgentR Wingmen](https://wingmen.app/) is a no-code AI platform that helps you build agents that handle sales, marketing, and creative tasks around the clock

**Key features:**

- **Seamless MCP Integration**: Easily connect to MCP servers to utilize a wide range of external tools.
- **Manage Knowledge Base**: Setup custom knowledge base for smarter and more accurate answers
- **Assistants**: Lets you organize chats, connect knowledge base, and set custom instructions and tools.
- **Shared workspace**: Invite your teams members, mangae access control and share your tools and assistants

**Learn more:**

- [AgentR Wingmen MCP Integration](https://wingmen.app/)
