...
| [Firebender][Firebender]                         | ❌          | ❌        | ✅      | ❌                     | ❌         | ❌    | Supports tools.                                                                                 |
...
[Firebender]: https://docs.firebender.com/context/mcp
...
[Firebender](https://firebender.com/) is an IntelliJ plugin that offers world class coding agent with MCP integration on tool calling.
