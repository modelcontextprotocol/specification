...
| [Ollamac][Ollamac]                               | ❌          | ❌        | ✅      | ❌                     | ❌         | ❌    | Supports tools                                                                                  |
...
[Ollamac](https://ollamac.com) is a a native macos Ollama client. Ollamac supports MCP, RAG, Chat and more.

**Key features:**

- Remote and local MCP servers support
- Rag local documents
- 100% local
