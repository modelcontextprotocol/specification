...
| [Jiki][Jiki]                                     | ✅          | ✅        | ✅      | ✅                     | ✅         | ❌    | Orchestration framework with dynamic tool/roots discovery |
...
[Jiki]: https://github.com/teilomillet/jiki
...
### Jiki
[Jiki](https://github.com/teilomillet/jiki) is a flexible LLM orchestration framework designed for building applications that leverage tool calling via the Multi-Capability Protocol (MCP).

**Key features:**
- Orchestration framework [docs](https://docs.jiki.dev)
- Auto-discover tools from MCP servers (stdio and SSE).
- Detailed interaction data with tool_calls and raw traces.
