...
| [Google ADK][Google ADK]                         | ❌          | ❌        | ✅      | ❓                     | ❌         | ❌    | Supports tools.                                                                                 |
...
[Google ADK](https://github.com/google/adk-python) is an open-source, code-first Python toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

**Key features:**

- **Rich Tool Ecosystem**: Utilize pre-built tools, MCP tools, custom functions, OpenAPI specs, or integrate existing tools to give agents diverse capabilities, all for tight integration with the Google ecosystem.
