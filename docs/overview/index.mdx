  ...
  <div className="hero-section">
    ...
    <div className="intro-video-section">
      <div className="intro-content">
        ...
        <p className="intro-description">
          Whether it's reading files from your computer, searching through an internal or external knowledge base, or updating tasks in an external project management tool, MCP provides a secure, standardized way to give AI systems the context they need to truly assist you.
        </p>
      </div>
