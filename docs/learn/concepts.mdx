---
title: "Understanding MCP Concepts"
description: "Understand the core concepts of MCP"
---
...
- **"Plan a vacation"** - Asks about dates, budget, preferences, and creates a complete itinerary
- **"Compare destinations"** - Analyzes weather, costs, and activities for multiple places
...
The key to tools is that you always remain in control. Here's how it works:

1. **AI Recognizes a Need**: "I found a great flight option for your dates"
2. **AI Asks Permission**: "Would you like me to search for hotels near the airport?"
3. **You Review**: You see exactly what will happen
4. **You Decide**: Approve or decline the action
5. **AI Acts**: Only with your permission
6. **You See Results**: "Found 15 hotels, sorted by rating and price"
...
MCP transforms AI from a conversational partner into a capable assistant that can:
- **Access** the information it needs (resources)
- **Follow** proven workflows for common tasks (prompts)
- **Take** helpful actions on your behalf (tools)
- **Keep** you in control throughout the process

This creates AI experiences that are both powerful and trustworthy, helping you accomplish real tasks while ensuring your privacy and maintaining your control over important decisions.

## Getting Started

As you explore MCP-enabled applications, remember:
- **Resources** = What the AI can see
- **Prompts** = How you ask for help
- **Tools** = What the AI can do

Together, they create an AI assistant that truly understands your context and can help you get things done.