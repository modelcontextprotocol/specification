...
- Non-goals:
  - MCP user support: participants are expected to to read official documentation and start new GitHub Discussions for questions or support.
...
- **Transparency requirements**:
  - **All decisions** affecting the community **must be documented** in GitHub Discussions and/or Issues, and will be labeled with `notes`.
