...
**Recommended path**: [User Quickstart](/docs/quickstart/user) → [Connect Server to Client Tutorial](/docs/tutorials/connect-server-client)

### 🔧 **I want to build an MCP server**

Start here if you're creating tools, data sources, or services for AI assistants.

**Recommended path**: [Server Quickstart](/docs/quickstart/server) → [Build a Weather Server Tutorial](/docs/tutorials/weather-server) → [Core Server Concepts](/docs/learn/server-concepts)

### 🏗️ **I want to build an MCP client**

Start here if you're integrating MCP support into an AI application.

**Recommended path**: [Client Quickstart](/docs/quickstart/client) → [Build a Node.js Client Tutorial](/docs/tutorials/building-a-client-node) → [Core Client Concepts](/docs/learn/client-concepts)
...
- [Specification](/docs/specification) - Complete protocol documentation
- [Python SDK](/docs/links/sdks/python) - Server and client libraries for Python
- [TypeScript SDK](/docs/links/sdks/typescript) - Server and client libraries for TypeScript
- [Examples](/docs/examples) - Real-world MCP implementations
- [FAQs](/docs/faqs) - Common questions and answers

---

Ready to start building with MCP? Choose your path above or explore the [introduction](/docs/introduction) for a gentle overview of the protocol.
