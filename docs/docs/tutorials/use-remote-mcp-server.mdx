...
The key advantage of remote MCP servers is their accessibility. Unlike local servers that require installation and configuration on each device, remote servers are available from any Claude session with an internet connection. This makes them ideal for team collaboration, cloud-based workflows, and accessing services that require server-side processing or authentication.
...
<Frame>
  <img src="/images/quickstart-remote/1-add-connector.png" alt="Add custom connector button in Claude settings" />
</Frame>
...
<Frame>
  <img src="/images/quickstart-remote/2-connect.png" alt="Dialog for entering remote MCP server URL" />
</Frame>
...
<Frame>
  <img src="/images/quickstart-remote/3-auth.png" alt="Authentication screen for remote MCP server" />
</Frame>
...
<Frame>
  <img src="/images/quickstart-remote/4-select-resources-menu.png" alt="Attachment menu showing available resources" />
</Frame>
...
<Frame>
  <img src="/images/quickstart-remote/6-configure-tools.png" alt="Tool permission configuration interface" />
</Frame>
...
To deepen your understanding and expand your use of MCP:
- [Build your own remote MCP server](https://support.anthropic.com/en/articles/11503834-building-custom-connectors-via-remote-mcp-servers) to create custom integrations
- Explore the [MCP specification](/docs/specification) to understand the protocol's full capabilities
- Browse [available MCP servers](https://github.com/modelcontextprotocol/servers) for additional integration options
