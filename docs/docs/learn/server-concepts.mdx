...
Instead of manually copying this information, resources let the AI application provide the information to the model, with user permission. During planning, the AI can check calendar availability, look up weather patterns, and reference travel preferences—all through structured resource access.
