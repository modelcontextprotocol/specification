...
Clients may provide several key features that enhance server capabilities:
...
The tool queries airline APIs and gathers dozens of flight options. It then requests AI assistance to analyze these options: "Analyze these flight options and recommend the best choice: [...] User preferences: morning departure, max 1 layover."
