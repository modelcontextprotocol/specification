...
In addition to making use of server features via _client-initiated requests_, clients may optionally provide several key features that enhance server capabilities, via _server-initiated requests_:
