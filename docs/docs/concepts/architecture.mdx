...
Before establishing a connection, clients may use [server discovery](/docs/concepts/discovery) to automatically detect available MCP servers when users provide URLs from MCP-enabled domains.
