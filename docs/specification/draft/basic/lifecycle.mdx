---
title: Lifecycle
description: "Connection lifecycle and state management"
---
...
- The client **SHOULD NOT** send requests other than
  [pings](/specification/draft/basic/utilities/ping) before the server has
  responded to the `initialize` request.
- The server **SHOULD NOT** send requests other than
  [pings](/specification/draft/basic/utilities/ping) and
  [logging](/specification/draft/server/utilities/logging) before receiving
...
For the stdio [transport](/specification/draft/basic/transports), the
...
For HTTP [transports](/specification/draft/basic/transports), shutdown is
