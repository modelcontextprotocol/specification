...
#### 1.2.2.2 Third-Party MCP Server Architecture
...
#### 2.1.1 Architecture and Attack Flows

##### 2.1.1.1 Normal OAuth proxy usage (preserves user consent)
...
##### 2.1.1.3 Malicious OAuth proxy usage (skips user consent)
