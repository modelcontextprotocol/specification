...
## Namespace Format
A namespace must be a string of is any of alphanumeric characters (A-Z, a-z, 0-9), underscores, dots (.), and hyphens.
For instance, com.github would be an acceptable namespace.

### Tool, Resource, and Prompt Names
As part of being in a namespace, a tool name, resource name, or prompt name **MUST** begin with the namespace, e.g.
