...
| `audience`             | REQUIRED          | The Issuer URL of the MCP server's authorization server.                                                                                                                 | `https://mcp.example.com/auth`                                                                         |
| `resource`             | REQUIRED          | The RFC9728 Resource Identifier of the MCP server.                                                                                            | —                                                                                                      |
