...
considerations that all implementors must carefully address. A detailed security extension, the Enhanced Tool Definition Interface (ETDI), provides a comprehensive framework for addressing many of these concerns. See the [ETDI Specification](/specification/draft/enhanced_tool_definition_interface) for more details.
...
<CardGroup cols={3}>
  ...
  <Card title="ETDI Security" icon="shield-halved" href="/specification/draft/enhanced_tool_definition_interface" />
