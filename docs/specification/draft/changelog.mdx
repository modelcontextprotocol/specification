...
9. Enhance authorization server discovery with support for [OpenID Connect Discovery 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html). (PR [#677](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/677))
