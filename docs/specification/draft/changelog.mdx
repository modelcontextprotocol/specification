...
7. Standardized the error code when requests are done without an initialization detected in the server to -32080.
   (PR [#742](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/742))
