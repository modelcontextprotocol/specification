...
- `inputSchema`: [JSON Schema Draft 2020-12](https://json-schema.org/draft/2020-12) of `type: object` defining expected parameters
- `outputSchema`: Optional [JSON Draft Schema 2020-12](https://json-schema.org/draft/2020-12) defining expected output structure
