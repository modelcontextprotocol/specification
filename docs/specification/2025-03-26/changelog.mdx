...
1. Added **structured JSON content type** support for returning structured data from tools
   (PR [#XXX](https://github.com/modelcontextprotocol/specification/pull/XXX))
1. Added **outputSchema** property to tools to define the expected JSON schema for tool results
   (PR [#XXX](https://github.com/modelcontextprotocol/specification/pull/XXX))
