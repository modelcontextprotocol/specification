...
[Section 2.5](#25-delegated-authorization-or-colocated-as-flows) to act as an AS.
...
1. Clients **MUST** securely store tokens following OAuth 2.1 best practices, as
   outlined in the
