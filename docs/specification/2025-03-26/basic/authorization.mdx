...
#### 2.4.3 Implementing custom authorization servers

MCP servers **MAY** implement their own AS.
...
MCP servers that implement their own AS **MUST**:
...
### 2.5 Implementing authorization server overrides
