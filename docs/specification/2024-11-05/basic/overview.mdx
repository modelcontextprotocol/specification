---
title: Overview
description: "Overview of base protocol elements"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Resources" icon="file" href="/specification/2024-11-05/server/resources">
    How servers provide data to clients
  </Card>
  <Card title="Prompts" icon="comments" href="/specification/2024-11-05/server/prompts">
    Templated messages for users
  </Card>
  <Card title="Tools" icon="screwdriver-wrench" href="/specification/2024-11-05/server/tools">
    Functions for AI models to execute
  </Card>
  <Card title="Logging" icon="clipboard" href="/specification/2024-11-05/server/utilities/logging">
