...
<CardGroup cols={3}>
  <Card title="Architecture" icon="template" href="/specification/2024-11-05/architecture" />
  ...
  <Card title="Contributing" icon="pencil" href="/specification/2024-11-05/contributing" />
</CardGroup>
