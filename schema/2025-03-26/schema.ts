...
export interface ClientCapabilities {
  ...
  contentTypes?: {
     ...
     * can may be included in the LLM's context window. Servers may adapt their
...
export interface ServerCapabilities {
  ...
  contentTypes?: {
    /**
     * MIME types the Server may produce.
     *
     * For example: ["audio/*", "application/json"]
     *
     * This list is non-exclusive and intended to help Hosts understand what content
     * types may be generated by the Server.
     * Servers that support Structured Outputs should advertise "application/json" here.
     */
    generates?: string[];
  };
}
